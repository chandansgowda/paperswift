...
class QuestionPaperDetailContainer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<QuestionPaperReviewController>(builder: (controller) {
      return Obx(() {
        return questionPaperReviewController.isLoading.value
            ? SizedBox(
            ...
            : controller
                    .questionPaperDetail
                    .departments[controller.currentDepartmentIndex.value]
                    .courses
                    .isEmpty
                ? Center(child: Text("No data 1"))
                : Container(
                            ...
                            Column(
                              children: List.generate(
                                controller
                                    .questionPaperDetail
                                    .departments[
                                        controller.currentDepartmentIndex.value]
                                    .courses
                                    .length,
...
Row assignmentTile(BuildContext context, Course course, int courseIndex) {
  ...
  return Row(
    children: [
      ...
      //                         content:
      //                             Text("Confirm before accepting the document"),
      //                         actions: [
      //                           ElevatedButton(
      //                             onPressed: () {
      //                               Get.back();
      ...
      //                                     .fetchData(examinationDetailController
      //                                         .examinationId);
      //                               },
      //                               child: Text("Accept"))
      //                         ],
      ...
      //                     });
      //               } else {
      //                 Get.snackbar("Can't be accepted",
      //                     "The new paper is not yet uploaded");
      //               }
      //             },
      //             child: Container(
      //               decoration: BoxDecoration(
      ...
      //               _showInputDialog(
      //                   context,
      //                   examinationDetailController.examinationId,
      //                   course.code,
      //                   "admin@admin.com",
      //                   course.trackingToken);
      //             },
      //             child: Container(
      //               decoration: BoxDecoration(
      //                 color: Colors.blue,
          ...
          child: GestureDetector(
            ...
            onTap: () async {
              if (course.qpDocUrl == "NA") {
                Get.snackbar(
                    "Can't access", "The document is not yet uploaded");
              } else {
...
void _showInputDialog(BuildContext context, int examId, String courseCode,
    String email, String trackingToken) {
